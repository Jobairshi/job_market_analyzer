  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <button
        ...
        disabled={loading || (!skills && !location && !resumeText)}
        className="mt-6 rounded-lg bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 disabled:opacity-50 transition"
      >
      ...
      {result && (
        <div className="mt-10">
          <h2 className="text-xl font-semibold text-gray-900">
            Top {result.total} Recommendations
          </h2>
